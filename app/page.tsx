...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-[#05060A] pb-20">
      {/* Main Content */}
      <section className="container mx-auto px-4 py-6 md:py-8">
        <div className="max-w-6xl mx-auto">
          {/* Hero: EliteScore + Streak + Stats in one card */}
          <div className="glass-card rounded-2xl bg-gradient-to-br from-[#050814] via-[#05060A] to-[#05060A] backdrop-blur-md p-6 md:p-8 mb-6 md:mb-8 shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-gradient-to-r from-[#0ea5e9]/15 via-[#fb923c]/20 to-[#f97316]/15 blur-[110px] rounded-full -z-10" />
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
              ...
              <div className="md:col-span-6 flex flex-col items-center md:items-start justify-center text-center md:text-left">
                ...
                <div className="text-5xl sm:text-6xl md:text-7xl font-black bg-gradient-to-r from-[#0ea5e9] via-[#fb923c] to-[#f97316] bg-clip-text text-transparent animate-gradient-x py-1 drop-shadow-sm">
                  {userData.eliteScore}
                </div>
                <Badge
                  variant="secondary"
              ...
              <div className="md:col-span-6 flex flex-col gap-4">
                <div className="glass-card rounded-xl bg-orange-500/5 backdrop-blur-sm p-4 flex flex-row items-center gap-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="glass-card rounded-xl bg-card/30 backdrop-blur-sm p-3">
          ...
          {/* Week at a glance */}
          <div className="glass-card rounded-2xl bg-[#050814] backdrop-blur-md p-4 mb-8 flex flex-wrap items-center justify-between gap-4">
          ...
          {/* Active Challenges */}
          <div className="glass-card rounded-2xl bg-gradient-to-br from-[#050814] to-[#05060A] backdrop-blur-md p-6 md:p-8 mb-8 shadow-xl relative overflow-hidden">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4">
              {activeChallenges.map((challenge) => (
                <div
                  key={challenge.id}
                  className="glass-card rounded-xl bg-card/30 backdrop-blur-sm p-4 transition-all"
                >
                  ...
                  <div className="space-y-3 mb-4">
                    <div className="glass-card rounded-lg bg-white/5 p-2.5">
                  ...
                  <div className="glass-card rounded-lg bg-[#0b1120] p-3 mb-4">
                  ...
                  <Button size="sm" asChild className="w-full bg-gradient-to-r from-[#0ea5e9] via-[#fb923c] to-[#f97316] hover:opacity-90 text-white border-0 text-[10px] h-8 font-bold uppercase tracking-wider">
              ...
              {leaderboardPreview.map((user) => (
                <div
                  key={user.rank}
                    ...
                    user.isCurrentUser
                      ? "bg-gradient-to-r from-[#0ea5e9]/10 via-[#fb923c]/10 to-[#f97316]/10 border-y border-[#0ea5e9]/20"
          ...
          {/* Improvement Insight */}
          <div className="glass-card rounded-2xl bg-gradient-to-r from-[#0ea5e9]/5 via-[#fb923c]/10 to-[#f97316]/10 backdrop-blur-md p-5 mb-8 shadow-xl">
          ...
          <div className="glass-card rounded-2xl bg-gradient-to-br from-[#050814] to-[#05060A] backdrop-blur-md p-6 md:p-8 shadow-xl relative overflow-hidden">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#0ea5e9]/10 flex items-center justify-center flex-shrink-0" aria-hidden="true">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
              {recommendedChallenges.map((challenge) => (
                <Link key={challenge.id} href="/challenges" className="glass-card rounded-xl bg-[#050814] backdrop-blur-sm p-4 transition-all group block">
