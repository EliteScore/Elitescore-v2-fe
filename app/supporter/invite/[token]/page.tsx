  ...
  if (type === "invalid" || type === "expired") {
    return (
      <div className={cn(baseCardClass, "border-red-500/20")}>
        ...
        <Button
          onClick={() => router.push("/")}
          className="w-full min-h-[48px] sm:h-10 bg-gradient-to-r from-[#0ea5e9] to-[#0f766e] hover:opacity-90 text-white border-0 text-xs sm:text-[10px] font-bold uppercase tracking-wider touch-manipulation"
      ...
      <div className="w-full max-w-md flex flex-col flex-1 py-4">
        ...
        <div className="glass-card rounded-2xl border border-[#0ea5e9]/20 bg-gradient-to-br from-card/80 to-background backdrop-blur-md p-5 sm:p-6 md:p-8 shadow-xl relative overflow-hidden">
          ...
          <div className="text-center mb-5 sm:mb-6">
            <div
              className="w-12 h-12 rounded-xl bg-[#0ea5e9]/10 flex items-center justify-center mx-auto mb-4"
              aria-hidden="true"
            >
            ...
            <h1 className="text-lg sm:text-xl font-bold mb-2 leading-tight">
              <span className="text-[#0ea5e9]">{inviterName}</span> invited you to be a Supporter
            </h1>
          ...
          <div className="glass-card rounded-xl border border-[#0ea5e9]/20 bg-[#0ea5e9]/5 p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <Badge
                variant="outline"
                className="text-[10px] border-[#0f766e]/30 text-[#0f766e] font-bold uppercase tracking-wider"
              >
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              <div className="glass-card rounded-xl border border-white/5 bg-card/30 p-3 flex items-start gap-3">
                <Bell className="w-4 h-4 text-[#0ea5e9] mt-0.5 shrink-0" aria-hidden="true" />
                <div>
              ...
              <div className="glass-card rounded-xl border border-white/5 bg-card/30 p-3 flex items-start gap-3">
                <Eye className="w-4 h-4 text-[#0f766e] mt-0.5 shrink-0" aria-hidden="true" />
                <div>
          ...
          <div className="flex flex-col gap-3">
            <Button
              ...
              className="w-full min-h-[48px] sm:h-10 text-xs sm:text-[10px] font-bold uppercase tracking-wider bg-gradient-to-r from-[#0ea5e9] to-[#0f766e] hover:opacity-90 text-white border-0 touch-manipulation"
