...
export function MorphPanel() {
  ...
  return (
    <div className="relative flex items-end justify-end" style={{ width: FORM_WIDTH, height: FORM_HEIGHT }}>
      <motion.div
        ref={wrapperRef}
        data-panel
        className={cx(
          "bg-background relative z-3 flex flex-col items-center overflow-hidden border origin-bottom-right"
        )}
        initial={false}
        animate={{
    ...
    <footer className="mt-auto flex h-[44px] items-center justify-center whitespace-nowrap select-none">
      <div className="flex items-center justify-center gap-2 px-3 max-sm:h-10 max-sm:px-2">
        ...
        <Button
          ...
          onClick={triggerOpen}
        >
          <span className="truncate">Ask Elite</span>
        </Button>
      </div>
    </footer>
  )
